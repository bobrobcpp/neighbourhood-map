...
var viewModel =function (){
  ...
  $.getJSON(self.bigUrl, function(data){
    ...
    //   console.log(data.response.group.results[i].venue.name + ", Latitude: " + data.response.group.results[i].venue.location.lat + ", Longitude: " + data.response.group.results[i].venue.location.lng);
    //   self.locationList.push(new placeListItem(data.response.group.results[i].venue));
    // };
